...
<div id="contentbox_main" style="padding-right: 20px; padding-top: 150px; padding-left: 20px; padding-bottom: 50px; position: relative; border: solid 5px #6EB438;">
  ...
  <!-- DCSTACK ELEMENTS -->
  <img style="position: absolute; bottom: -2px; right: 15px;" src="images/giraffe.png">
  <img class="quote1" src="images/quote1.png">
  <img class="quote2" src="images/quote2.png">
  <img class="quote3" src="images/quote3.png">
  <!-- DCSTACK ELEMENTS -->
  <div class="fade-content"> <!-- opacity -->
