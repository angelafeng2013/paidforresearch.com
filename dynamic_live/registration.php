    ...
    <form id="registration_form" method="get" name="hostedform" class="hostedform" enctype="text" action="questions.php">
      ...
      <div class="input-field col s12">
        <p class="material-tcpa">
          ...
          <label for="chk_agree" style="font-size: 11px;">

             I agree to the <a href="http://www.paidforresearch.com/terms.htm" target="_blank">Terms of Use</a> &amp; <a href="http://www.paidforresearch.com/privacy.htm" target="_blank">Privacy Policy</a>, to receive daily emails from PaidForResearch and Research Unlimited, and to receive calls and texts from Omni Research using an automated dialing system and/or prerecorded voice, which is not a condition to purchase any goods or services.
      ...
      <div class="col s12">
          <div class="spacer"></div>
            <div class="button-holder">
              ...
              <!-- <img id="loader-gif" src="http://leadreactor.engageiq.com/images/gallery/loader.gif" width="15%" style="display: none;" /> -->
