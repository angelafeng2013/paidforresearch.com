<?php 
        ...
        if($_POST && isset($_POST['type'])) {
                if($_POST['type'] == 'set_session') {
                        ...
                        $_SESSION['campaign_types'] = isset($data['campaign_types']) ? $data['campaign_types'] : array();
        ...
        if(strpos($html,'[VALUE_BIRTHDATE_MDY]') !== false) $html = str_replace('[VALUE_BIRTHDATE_MDY]', $_SESSION['user']['dobmonth'].'/'.$_SESSION['user']['dobday'].'/'.$_SESSION['user']['dobyear'], $html);
        ...
        /*FOR NLR*/if(strpos($html,'http://leadreactor.engageiq.com/sendLead/') !== false) $html = str_replace('http://leadreactor.engageiq.com/sendLead/', 'https://leadreactor.engageiq.com/sendLead/', $html);
        /*FOR LF*/if(strpos($html,'http://leadfilter.engageiq.com/storeLead') !== false) $html = str_replace('http://leadfilter.engageiq.com/storeLead', 'https://leadfilter.engageiq.com/storeLead', $html);
        /*FOR NLR IMG*/if(strpos($html,'http://leadreactor.engageiq.com/images/gallery/') !== false) $html = str_replace('http://leadreactor.engageiq.com/images/gallery/', 'https://leadreactor.engageiq.com/images/gallery/', $html);
        ...
        function fire_pixel() {
                ...
                if(isset($_SESSION['pixel']) && $_SESSION['pixel']['postback'] != '' && !isset($_SESSION['pixel']['done'])) {
                        ...
                        if($file == 'index.php' && $fire_at == 1) { //Landing Page
                                ...
                                $parsed = parse_str($string, $output);
                                echo '<!-- '.$string.' -->';
                                echo '<!-- '.$output['campaign'].' -->';
                                echo '<!-- '.$fire_at.' -->';
                                $total_pages = count($_SESSION['campaigns']);
                                $cpawall = $total_pages-1;
                                if($output['campaign'] == $total_pages && $fire_at == 13) { //Last Submit Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == $cpawall && $fire_at == 12) { //CPAWALL Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 1 && $fire_at == 3) { //1st Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 2 && $fire_at == 4) { //2nd Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 3 && $fire_at == 5) { //3rd Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 4 && $fire_at == 6) { //4th Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 5 && $fire_at == 7) { //5th Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 6 && $fire_at == 8) { //6th Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 7 && $fire_at == 9) { //7th Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 8 && $fire_at == 10) {//8th Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                                else if($output['campaign'] == 9 && $fire_at == 11) { //9th Offer Page
                                        echo offer_html($postback); 
                                        $_SESSION['pixel']['done'] = 1;
                                }
                        }
